...
# Train the model
history = model.fit(X_train_scaled, y_train_scaled, epochs=50, batch_size=32, validation_split=0.1, verbose=1)
...
model.save('two-year-half-hourly/lstm/lstm_model.h5')
